...
export default function Login() {
    ...
    const onLogin = async () => {
        ...
        try {
            ...
            // After signIn, onAuthStateChanged in AuthContext will update user and RootNavigator will show Dashboard.
        } catch (err: any) {
...
const styles = StyleSheet.create({
    ...
    title: { marginBottom: 20, textAlign: "center", fontSize: 20 },
